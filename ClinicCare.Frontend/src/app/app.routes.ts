...
export const routes: Routes = [
  ...
  { path: 'admin', loadChildren: () => import('./features/dashboard/dashboard.routes').then(m => m.DASHBOARD_ROUTES)},
  ...
  { path: 'my-profile', loadChildren: () => import('./features/myprofile/myprofile.routes').then(m => m.MYPROFILE_ROUTES)},
];
